...
class RandomPlayer(BasePokerPlayer):
  ...
  def __init__(self, history, hashOfGame, distribution, actionsHistory):
    super(RandomPlayer, self).__init__(history, hashOfGame)
    self.distribution = distribution
    self.fold_ratio = distribution["Fold"]
    self.call_ratio = distribution["Call"]
    self.raise_ratio = distribution["Bet"]
